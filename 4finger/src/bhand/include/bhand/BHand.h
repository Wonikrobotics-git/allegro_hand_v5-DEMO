...
public:
	...
	void SetGraspingPose(double x[4], double y[4],double z[4]);
...
private:
	...
	//////// To change standing position when grasp motion.
	double _x_offset[NOF];
	double _y_offset[NOF];
	double _z_offset[NOF];
